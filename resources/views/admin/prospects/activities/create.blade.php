            ...
            <div class="card-body">
                <form action="{{ route('admin.prospects.activities.store', $prospect) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea name="followup_notes" cols="30" rows="10" class="form-control" placeholder="Enter in your notes to help remind you of what to do for the next follow up"></textarea>
                        </div>
                    </div>
